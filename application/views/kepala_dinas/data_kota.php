                ...
                <tr>
                  ...
                  <td>
                    <center>
                      ...
                      <a href="<?= base_url('kepala_dinas/Kota?delete=true&id=' . $row->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                    </center>
                  </td>
                </tr>
              <?php $i++;endforeach; ?>
  ...
  <style type="text/css"> .required{color: red;} </style>
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="add">
              <div class="modal-dialog" role="document">
                <?= form_open_multipart('kepala_dinas/kota', ['id' => 'tambah']) ?>
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="edit">
              <div class="modal-dialog" role="document">
                <?= form_open_multipart('kepala_dinas/kota', ['id' => 'edit_data']) ?>
               <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <script>
                ...
                function get_kota(id) {
                  $.ajax({
                    url: '<?= base_url('kepala_dinas/Kota') ?>',
                    type: 'POST',
                    data: {
                      id: id,
                      get: true
